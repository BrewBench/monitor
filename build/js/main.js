...
angular.module('brewbench-monitor').controller('mainCtrl', function ($scope, $state, $filter, $timeout, $interval, $q, $http, $sce, BrewService) {
  ...
  $scope.updateTemp = function (response, kettle) {
    ...
    if (response.volts) {
      ...
      if (kettle.temp.type == 'Thermistor' && kettle.temp.pin.indexOf('A') === 0 && response.volts < 2.5) {
...
angular.module('brewbench-monitor').factory('BrewService', function ($http, $q, $filter) {
  ...
  return {
    ...
    kettleTypes: function kettleTypes(type) {
      var kettles = [{ 'name': 'Boil', 'type': 'hop', 'target': 200, 'diff': 2 }, { 'name': 'Mash', 'type': 'grain', 'target': 152, 'diff': 2 }, { 'name': 'Hot Liquor', 'type': 'water', 'target': 170, 'diff': 2 }, { 'name': 'Fermenter', 'type': 'fermenter', 'target': 74, 'diff': 2 }, { 'name': 'Air', 'type': 'air', 'target': 74, 'diff': 2 }, { 'name': 'Soil', 'type': 'hubspot', 'target': 60, 'diff': 2 }];
